...
always@(*)begin
	case(Opcode)
		...
		`sw:begin
			MemToReg =0; MemWrite =1; Branch_e =0; Branch_n =0; ALUSrc =1; RegDst =0; RegWrite =0; SignExtend =1; ALUCTRL = `ADD;
		end
		`RType:begin
			case(funct)
				`R_add:begin
				...
				default:begin
					MemToReg =0; MemWrite =0; Branch_e =0; Branch_n =0; ALUSrc =0; RegDst =1; RegWrite =0; SignExtend =0; ALUCTRL = `ADD;
				end
			endcase
		end
	endcase
